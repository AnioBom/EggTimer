...
extension ViewController {
    final class ProgressView: UIView {
        ...
        func drawProgress(with percent: CGFloat) {
                    ...
                    defaultCircleLayer.strokeColor = CGColor(red: 226/255, green: 98/255, blue: 98/255, alpha: 1)
                    ...
                    circleLayer.strokeColor = CGColor(red: 226/255, green: 90/255, blue: 100/255, alpha: 1)
                    ...
                    bigDotLayer.strokeColor = CGColor(red: 226/255, green: 90/255, blue: 100/255, alpha: 1)
                    ...
                    (1...9).forEach { _ in
                        ...
                        barLayer.strokeColor = angle >= (7 / 6 - (8 / 6 * percent))
                            ? CGColor(red: 226/255, green: 90/255, blue: 100/255, alpha: 1) : CGColor(red: 226/255, green: 98/255, blue: 98/255, alpha: 1)
